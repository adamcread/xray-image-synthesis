...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '../dataset/xray/composed/4482_real_1918_fake/helper/annotation/unpaired_combined_tversky_700.json',
        img_prefix=
        '../dataset/xray/composed/4482_real_1918_fake/unpaired_combined_tversky_700/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
...
classes = ('FIREARM', 'KNIFE')
work_dir = 'work_dirs/4482_real_1918_fake/fsaf/unpaired_combined_tversky_700/'
auto_resume = False
gpu_ids = [0]
