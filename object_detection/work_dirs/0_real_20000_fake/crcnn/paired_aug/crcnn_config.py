...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '../dataset/xray/composed/0_real_20000_fake/helper/annotation/paired_aug.json',
        img_prefix='../dataset/xray/composed/0_real_20000_fake/paired_aug/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
...
classes = ('FIREARM', 'KNIFE')
work_dir = 'work_dirs/0_real_20000_fake/crcnn/paired_aug/'
auto_resume = False
gpu_ids = [0]
