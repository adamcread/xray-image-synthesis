...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '../dataset/xray/composed/0_real_20000_fake/helper/annotation/unpaired_combined_dice_500.json',
        img_prefix=
        '../dataset/xray/composed/0_real_20000_fake/unpaired_combined_dice_500/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
...
classes = ('FIREARM', 'KNIFE')
work_dir = 'work_dirs/0_real_20000_fake/fsaf/unpaired_combined_dice_500/'
auto_resume = False
gpu_ids = [0]
